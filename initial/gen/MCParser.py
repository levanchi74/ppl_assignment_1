...
class MCParser ( Parser ):
    ...
    class ArrptrtypeContext(ParserRuleContext):
        ...
        def enterRule(self, listener:ParseTreeListener):
            if hasattr( listener, "enterArrptrtype" ):
                listener.enterArrptrtype(self)

        def exitRule(self, listener:ParseTreeListener):
            if hasattr( listener, "exitArrptrtype" ):
    ...
    class ContistmtContext(ParserRuleContext):
        ...
        def enterRule(self, listener:ParseTreeListener):
            if hasattr( listener, "enterContistmt" ):
                listener.enterContistmt(self)

        def exitRule(self, listener:ParseTreeListener):
            if hasattr( listener, "exitContistmt" ):
    ...
    class ElearrayContext(ParserRuleContext):
        ...
        def enterRule(self, listener:ParseTreeListener):
            if hasattr( listener, "enterElearray" ):
                listener.enterElearray(self)

        def exitRule(self, listener:ParseTreeListener):
            if hasattr( listener, "exitElearray" ):
